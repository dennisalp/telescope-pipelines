...
timemax=393249000
tbin=120
pn_src_prel="circle(26021.634,19538.852,400)"
m1_src_prel="circle(26021.634,19538.852,400)"
m2_src_prel="circle(26021.634,19538.852,400)"
pn_bkg="circle(26829.316,21815.398,1498.9784)"
m1_bkg="circle(24238.535,15850.418,3424.3815)"
m2_bkg="circle(21716.673,16604.790,3823.6318)"
...
# emllist_idx=33
# DET_ML=105.8793, (117.101734214577, -67.8645055276354)
# uncertainty (1.557701**2+1.2**2)**0.5/3600.=0.0005462012758590712=1.9663245930926563 arcsec
coo="07:48:24.4162 -67:51:52.220"
coo_fit="circle(26010.73,19622.595,400)"

# optradius: 11 arcsecs 220 image units
# optradius: 12 arcsecs 240 image units
# optradius: 12 arcsecs 240 image units
pn_src="circle(26010.73,19622.595,220)"
m1_src="circle(26010.73,19622.595,240)"
m2_src="circle(26010.73,19622.595,240)"

# 10% FOR THIS ONE
# 27 counts within 244.724359 seconds between 393184602.691834 and 393184847.416193
tpeak_min=393184602.691834
tpeak_max=393184847.41619
tpeak_bin=244.724359
...
mk_evt () {
    ...
    evselect table=${id}_m1_${5} withfilteredset=Y \
             filteredset=${id}_m1_clean_evt_${1}.fits \
             destruct=Y keepfilteroutput=T \
             expression="(TIME>${2}) && (TIME<${3})"
    ...
    merge set1=${id}_pn_clean_evt_${1}.fits \
          set2=${id}_m1_clean_evt_${1}.fits \
          outset=${id}_tmp_clean_evt_${1}.fits
    merge set1=${id}_tmp_clean_evt_${1}.fits \
...
mk_img () {
    ...
    evselect table=${id}_m1_${2} imagebinning=binSize \
             imageset=${id}_m1_clean_img_${1}.fits withimageset=yes \
             xcolumn=X ycolumn=Y ximagebinsize=80 yimagebinsize=80
    ...
    emosaic imagesets="${id}_pn_clean_img_${1}.fits ${id}_m1_clean_img_${1}.fits ${id}_m2_clean_img_${1}.fits" \
...
print_img() {
    ...
    ${ds9} ${id}_m1_clean_img_${1}.fits -scale linear -cmap Heat -regions ${id}_m1_src.reg -pan to ${coo} wcs -zoom 2 -regions ${id}_m1_bkg.reg -print destination file -print filename ${id}_m1_clean_img_${1}.ps -print -exit
...
mk_src_list () {
    edetect_chain imagesets="${id}_pn_clean_img_${1}.fits ${id}_m1_clean_img_${1}.fits ${id}_m2_clean_img_${1}.fits" \
                  eventsets="${id}_pn_${2} ${id}_m1_${2} ${id}_m2_${2}" \
                  attitudeset=$(ls *AttHk.ds) \
                  pimin="300 300 300" \
                  pimax="10000 10000 10000" \
                  eboxl_list=${id}_eboxlist_l_${1}.fits eboxm_list=${id}_eboxlist_m_${1}.fits \
                  eml_list=${id}_emllist_${1}.fits eml_threshold=10

    esensmap detmasksets="${id}_pn_clean_img_${1}mask.fits ${id}_m1_clean_img_${1}mask.fits ${id}_m2_clean_img_${1}mask.fits" \
             expimagesets="${id}_pn_clean_img_${1}exp.fits ${id}_m1_clean_img_${1}exp.fits ${id}_m2_clean_img_${1}exp.fits" \
             bkgimagesets="${id}_pn_clean_img_${1}bkg.fits ${id}_m1_clean_img_${1}bkg.fits ${id}_m2_clean_img_${1}bkg.fits" \
...
mk_spec () {
    ...
    evselect table=${id}_m1_${2} withspectrumset=yes \
            spectrumset=${id}_m1_spec_src_${1}.fits energycolumn=PI spectralbinsize=5 \
            withspecranges=yes specchannelmin=0 specchannelmax=11999 \
            expression="(X,Y) IN ${m1_src}"
    evselect table=${id}_m1_${2} withspectrumset=yes \
            spectrumset=${id}_m1_spec_bkg_${1}.fits energycolumn=PI spectralbinsize=5 \
            withspecranges=yes specchannelmin=0 specchannelmax=11999 \
            expression="(X,Y) IN ${m1_bkg}"
    backscale spectrumset=${id}_m1_spec_src_${1}.fits badpixlocation=${id}_m1_${2}
    backscale spectrumset=${id}_m1_spec_bkg_${1}.fits badpixlocation=${id}_m1_${2}
    rmfgen spectrumset=${id}_m1_spec_src_${1}.fits rmfset=${id}_m1_spec_rmf_${1}.fits
    arfgen spectrumset=${id}_m1_spec_src_${1}.fits arfset=${id}_m1_spec_arf_${1}.fits withrmfset=yes \
          rmfset=${id}_m1_spec_rmf_${1}.fits badpixlocation=${id}_m1_${2} \
          detmaptype=psf
    specgroup spectrumset=${id}_m1_spec_src_${1}.fits mincounts=1 \
             rmfset=${id}_m1_spec_rmf_${1}.fits arfset=${id}_m1_spec_arf_${1}.fits \
             backgndset=${id}_m1_spec_bkg_${1}.fits groupedset=${id}_m1_spec_grp_${1}.fits
    fthedit "${id}_m1_spec_src_${1}.fits" BACKFILE add "${id}_m1_spec_bkg_${1}.fits"
    fthedit "${id}_m1_spec_src_${1}.fits" RESPFILE add "${id}_m1_spec_rmf_${1}.fits"
    fthedit "${id}_m1_spec_src_${1}.fits" ANCRFILE add "${id}_m1_spec_arf_${1}.fits"
...
mk_spec_ep () {    
    ...
    evselect table=${id}_m1_${2} withspectrumset=yes \
            spectrumset=${id}_m1_spec_src_tmp_${1}.fits energycolumn=PI spectralbinsize=200 \
            withspecranges=yes specchannelmin=0 specchannelmax=11999 \
            expression="(X,Y) IN ${m1_src}"
    evselect table=${id}_m1_${2} withspectrumset=yes \
            spectrumset=${id}_m1_spec_bkg_tmp_${1}.fits energycolumn=PI spectralbinsize=200 \
            withspecranges=yes specchannelmin=0 specchannelmax=11999 \
            expression="(X,Y) IN ${m1_bkg}"
    backscale spectrumset=${id}_m1_spec_src_tmp_${1}.fits badpixlocation=${id}_m1_${2}
    backscale spectrumset=${id}_m1_spec_bkg_tmp_${1}.fits badpixlocation=${id}_m1_${2}
    rmfgen spectrumset=${id}_m1_spec_src_tmp_${1}.fits rmfset=${id}_m1_spec_rmf_tmp_${1}.fits \
          withenergybins=yes energymin=0.1 energymax=12.0 nenergybins=2400
    arfgen spectrumset=${id}_m1_spec_src_tmp_${1}.fits arfset=${id}_m1_spec_arf_tmp_${1}.fits \
          withrmfset=yes rmfset=${id}_m1_spec_rmf_tmp_${1}.fits 
    ...
    epicspeccombine pha="${id}_pn_spec_src_tmp_${1}.fits ${id}_m1_spec_src_tmp_${1}.fits ${id}_m2_spec_src_tmp_${1}.fits" \
      bkg="${id}_pn_spec_bkg_tmp_${1}.fits ${id}_m1_spec_bkg_tmp_${1}.fits ${id}_m2_spec_bkg_tmp_${1}.fits" \
      rmf="${id}_pn_spec_rmf_tmp_${1}.fits ${id}_m1_spec_rmf_tmp_${1}.fits ${id}_m2_spec_rmf_tmp_${1}.fits" \
      arf="${id}_pn_spec_arf_tmp_${1}.fits ${id}_m1_spec_arf_tmp_${1}.fits ${id}_m2_spec_arf_tmp_${1}.fits" \
...
################################################################
# evselect table=$(ls *EPN*ImagingEvts.ds | head -1 | tail -1) withrateset=Y rateset=${id}_pn_bkg_flare1.fits \
#         maketimecolumn=Y timebinsize=100 makeratecolumn=Y \
#         expression="#XMMEA_EP && (PI>10000&&PI<12000) && (PATTERN==0)"
# evselect table=$(ls *EMOS1*ImagingEvts.ds | head -1 | tail -1) withrateset=Y rateset=${id}_m1_bkg_flare1.fits \
#         maketimecolumn=Y timebinsize=100 makeratecolumn=Y \
#         expression="#XMMEA_EM && (PI>10000) && (PATTERN==0)"
# evselect table=$(ls *EMOS2*ImagingEvts.ds | head -1 | tail -1) withrateset=Y rateset=${id}_m2_bkg_flare1.fits \
#         maketimecolumn=Y timebinsize=100 makeratecolumn=Y \
#         expression="#XMMEA_EM && (PI>10000) && (PATTERN==0)"
# evselect table=$(ls *EPN*ImagingEvts.ds | head -2 | tail -1) withrateset=Y rateset=${id}_pn_bkg_flare2.fits \
#         maketimecolumn=Y timebinsize=100 makeratecolumn=Y \
#         expression="#XMMEA_EP && (PI>10000&&PI<12000) && (PATTERN==0)"
# evselect table=$(ls *EMOS1*ImagingEvts.ds | head -2 | tail -1) withrateset=Y rateset=${id}_m1_bkg_flare2.fits \
#         maketimecolumn=Y timebinsize=100 makeratecolumn=Y \
#         expression="#XMMEA_EM && (PI>10000) && (PATTERN==0)"
# evselect table=$(ls *EMOS2*ImagingEvts.ds | head -2 | tail -1) withrateset=Y rateset=${id}_m2_bkg_flare2.fits \
#         maketimecolumn=Y timebinsize=100 makeratecolumn=Y \
#         expression="#XMMEA_EM && (PI>10000) && (PATTERN==0)"
# evselect table=$(ls *EMOS1*ImagingEvts.ds | head -3 | tail -1) withrateset=Y rateset=${id}_m1_bkg_flare3.fits \
#         maketimecolumn=Y timebinsize=100 makeratecolumn=Y \
#         expression="#XMMEA_EM && (PI>10000) && (PATTERN==0)"
# dsplot table=${id}_pn_bkg_flare1.fits x=TIME y=RATE
# dsplot table=${id}_m1_bkg_flare1.fits x=TIME y=RATE
# dsplot table=${id}_m2_bkg_flare1.fits x=TIME y=RATE
# dsplot table=${id}_pn_bkg_flare2.fits x=TIME y=RATE
# dsplot table=${id}_m1_bkg_flare2.fits x=TIME y=RATE
# dsplot table=${id}_m2_bkg_flare2.fits x=TIME y=RATE
# dsplot table=${id}_m1_bkg_flare3.fits x=TIME y=RATE
...
################################################################
# tabgtigen table=${id}_pn_bkg_flare1.fits expression="RATE<=${rate_pn_1}" gtiset=${id}_pn_gti1.fits
# tabgtigen table=${id}_m1_bkg_flare1.fits expression="RATE<=${rate_m1_1}" gtiset=${id}_m1_gti1.fits
# tabgtigen table=${id}_m2_bkg_flare1.fits expression="RATE<=${rate_m2_1}" gtiset=${id}_m2_gti1.fits
# tabgtigen table=${id}_pn_bkg_flare2.fits expression="RATE<=${rate_pn_2}" gtiset=${id}_pn_gti2.fits
# tabgtigen table=${id}_m1_bkg_flare2.fits expression="RATE<=${rate_m1_2}" gtiset=${id}_m1_gti2.fits
# tabgtigen table=${id}_m2_bkg_flare2.fits expression="RATE<=${rate_m2_2}" gtiset=${id}_m2_gti2.fits
# tabgtigen table=${id}_m1_bkg_flare3.fits expression="RATE<=${rate_m1_3}" gtiset=${id}_m1_gti3.fits

# evselect table=$(ls *EPN*ImagingEvts.ds | head -1 | tail -1) withfilteredset=Y \
#         filteredset=${id}_pn_clean_evt1.fits \
#         destruct=Y keepfilteroutput=T \
#         expression="#XMMEA_EP && gti(${id}_pn_gti1.fits,TIME) && (PI in [300:10000]) && (PATTERN<=4)"
# evselect table=$(ls *EMOS1*ImagingEvts.ds | head -1 | tail -1) withfilteredset=Y \
#         filteredset=${id}_m1_clean_evt1.fits \
#         destruct=Y keepfilteroutput=T \
#         expression="#XMMEA_EM && gti(${id}_m1_gti1.fits,TIME) && (PI in [300:10000]) && (PATTERN<=12)"
# evselect table=$(ls *EMOS2*ImagingEvts.ds | head -1 | tail -1) withfilteredset=Y \
#         filteredset=${id}_m2_clean_evt1.fits \
#         destruct=Y keepfilteroutput=T \
#         expression="#XMMEA_EM && gti(${id}_m2_gti1.fits,TIME) && (PI in [300:10000]) && (PATTERN<=12)"

# evselect table=$(ls *EPN*ImagingEvts.ds | head -2 | tail -1) withfilteredset=Y \
#         filteredset=${id}_pn_clean_evt2.fits \
#         destruct=Y keepfilteroutput=T \
#         expression="#XMMEA_EP && gti(${id}_pn_gti2.fits,TIME) && (PI in [300:10000]) && (PATTERN<=4)"
# evselect table=$(ls *EMOS1*ImagingEvts.ds | head -2 | tail -1) withfilteredset=Y \
#         filteredset=${id}_m1_clean_evt2.fits \
#         destruct=Y keepfilteroutput=T \
#         expression="#XMMEA_EM && gti(${id}_m1_gti2.fits,TIME) && (PI in [300:10000]) && (PATTERN<=12)"
# evselect table=$(ls *EMOS2*ImagingEvts.ds | head -2 | tail -1) withfilteredset=Y \
#         filteredset=${id}_m2_clean_evt2.fits \
#         destruct=Y keepfilteroutput=T \
#         expression="#XMMEA_EM && gti(${id}_m2_gti2.fits,TIME) && (PI in [300:10000]) && (PATTERN<=12)"

# evselect table=$(ls *EMOS1*ImagingEvts.ds | head -3 | tail -1) withfilteredset=Y \
#         filteredset=${id}_m1_clean_evt3.fits \
#         destruct=Y keepfilteroutput=T \
#         expression="#XMMEA_EM && gti(${id}_m1_gti3.fits,TIME) && (PI in [300:10000]) && (PATTERN<=12)"

# merge set1=${id}_pn_clean_evt1.fits \
#       set2=${id}_pn_clean_evt2.fits \
#       outset=${id}_pn_clean_evt.fits
# merge set1=${id}_m1_clean_evt1.fits \
#       set2=${id}_m1_clean_evt2.fits \
#       outset=${id}_m1_clean_evt.fits
# merge set1=${id}_m1_clean_evt.fits \
#       set2=${id}_m1_clean_evt3.fits \
#       outset=${id}_m1_clean_evt.fits
# merge set1=${id}_m2_clean_evt1.fits \
#       set2=${id}_m2_clean_evt2.fits \
#       outset=${id}_m2_clean_evt.fits
# rm *tmp*.fits
...
# evselect table=${id}_m1_dirty_evt.fits energycolumn=PI \
#         expression="(X,Y) IN ${m1_src_prel}" \
#         withrateset=yes rateset=${id}_m1_raw_src_prel_lc.fits timebinsize=${tbin} \
#         maketimecolumn=yes makeratecolumn=yes timemin=${timemin} timemax=${timemax}
# evselect table=${id}_m1_dirty_evt.fits energycolumn=PI \
#         expression="(X,Y) IN ${m1_bkg}" \
#         withrateset=yes rateset=${id}_m1_raw_bkg_lc.fits timebinsize=${tbin} \
#         maketimecolumn=yes makeratecolumn=yes timemin=${timemin} timemax=${timemax}
# epiclccorr srctslist=${id}_m1_raw_src_prel_lc.fits eventlist=${id}_m1_dirty_evt.fits \
#           outset=${id}_m1_lccorr_prel.fits bkgtslist=${id}_m1_raw_bkg_lc.fits \
#           withbkgset=yes applyabsolutecorrections=yes
...
# m1 = fits.open('${id}_m1_lccorr_prel.fits')[1].data
# plt.plot(m1['TIME']-${timemin}, m1['RATE'])
# m2 = fits.open('${id}_m2_lccorr_prel.fits')[1].data
# plt.plot(m2['TIME']-${timemin}, m2['RATE'])
# plt.plot(pn['TIME']-${timemin}, pn['RATE']+m1['RATE']+m2['RATE'])
# plt.legend(['pn', 'm1', 'm2', 'tot'])
...
# evselect table=${id}_m1_dirty_evt.fits withfilteredset=Y \
#         filteredset=${id}_m1_dirty_evt_during.fits \
#         destruct=Y keepfilteroutput=T \
#         expression="(TIME>${t_rise}) && (TIME<${t_fade})"
# evselect table=${id}_m1_dirty_evt_during.fits imagebinning=binSize \
#         imageset=${id}_m1_dirty_img_during.fits withimageset=yes \
#         xcolumn=X ycolumn=Y ximagebinsize=80 yimagebinsize=80
...
# emosaic imagesets="${id}_pn_dirty_img_during.fits ${id}_m1_dirty_img_during.fits ${id}_m2_dirty_img_during.fits" \
...
#                         ${id}_m1_dirty_img_during.fits \
#                         ${id}_m2_dirty_img_during.fits" \
#               eventsets="${id}_pn_dirty_evt_during.fits ${id}_m1_dirty_evt_during.fits ${id}_m2_dirty_evt_during.fits" \
#               attitudeset=$(ls *AttHk.ds) \
#               pimin="300 300 300" \
#               pimax="10000 10000 10000" \
...
# esensmap detmasksets="${id}_pn_dirty_img_duringmask.fits ${id}_m1_dirty_img_duringmask.fits ${id}_m2_dirty_img_duringmask.fits" \
#          expimagesets="${id}_pn_dirty_img_duringexp.fits ${id}_m1_dirty_img_duringexp.fits ${id}_m2_dirty_img_duringexp.fits" \
#          bkgimagesets="${id}_pn_dirty_img_duringbkg.fits ${id}_m1_dirty_img_duringbkg.fits ${id}_m2_dirty_img_duringbkg.fits" \
...
# eregionanalyse imageset=${id}_m1_dirty_img_during.fits \
#                srcexp="(X,Y) in ${coo_fit}" \
#                backexp="(X,Y) in ${m1_bkg}"
...
#         maketimecolumn=yes makeratecolumn=yes timemin=${timemin} timemax=${timemax}
# epiclccorr srctslist=${id}_m1_raw_src_lc.fits eventlist=${id}_m1_dirty_evt.fits \
...
#       set2=${id}_m1_dirty_evt_during.fits \
#       outset=${id}_tmp_dirty_evt_during.fits
# merge set1=${id}_tmp_dirty_evt_during.fits \
#       set2=${id}_m2_dirty_evt_during.fits \
#       outset=${id}_ep_dirty_evt_during.fits
# rm ${id}_tmp_dirty_evt_during.fits
...
# evselect table=${id}_m1_dirty_evt.fits energycolumn=PI \
#         expression="(X,Y) IN ${m1_src}" \
#         withrateset=yes rateset=${id}_m1_raw_src_lc_peak.fits timebinsize=${tpeak_bin} \
#         maketimecolumn=yes makeratecolumn=yes timemin=${tpeak_min} timemax=${tpeak_max}
# evselect table=${id}_m1_dirty_evt.fits energycolumn=PI \
#         expression="(X,Y) IN ${m1_bkg}" \
#         withrateset=yes rateset=${id}_m1_raw_bkg_lc_peak.fits timebinsize=${tpeak_bin} \
#         maketimecolumn=yes makeratecolumn=yes timemin=${tpeak_min} timemax=${tpeak_max}
# epiclccorr srctslist=${id}_m1_raw_src_lc_peak.fits eventlist=${id}_m1_dirty_evt.fits \
#           outset=${id}_m1_lccorr_peak.fits bkgtslist=${id}_m1_raw_bkg_lc_peak.fits \
#           withbkgset=yes applyabsolutecorrections=yes
...
# plt.plot(m1['TIME']-${t_rise}, m1['RATE'])
# m2 = fits.open('${id}_m2_lccorr.fits')[1].data
# plt.plot(m2['TIME']-${t_rise}, m2['RATE'])
# plt.plot(pn['TIME']-${t_rise}, pn['RATE']+m1['RATE']+m2['RATE'])

# pnp = fits.open('${id}_pn_lccorr_peak.fits')[1].data
# m1p = fits.open('${id}_m1_lccorr_peak.fits')[1].data
# m2p = fits.open('${id}_m2_lccorr_peak.fits')[1].data
# rp = pnp['RATE']+m1p['RATE']+m2p['RATE']
# rt = (${tpeak_min}+${tpeak_max})/2.*np.ones(2)-${t_rise}
# ep = np.sqrt(pnp['ERROR']**2+m1p['ERROR']**2+m2p['ERROR']**2)[0]
...
mk_evt before 0 ${t_before} clean_evt1.fits clean_evt1.fits
...
mk_evt after ${t_after} ${t_INF} clean_evt2.fits clean_evt3.fits
...
mk_evt first ${t_rise} ${t_mid} dirty_evt.fits dirty_evt.fits
...
mk_evt second ${t_mid} ${t_fade} dirty_evt.fits dirty_evt.fits
...
${ds9} ${id}_m1_dirty_img_during.fits -scale linear -cmap Heat -regions ${id}_m1_src.reg -pan to ${coo} wcs -zoom 2 -regions ${id}_m1_bkg.reg -print destination file -print filename ${id}_m1_dirty_img_during.ps -print -exit
