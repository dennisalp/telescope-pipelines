...
tbin=4
tbpy=4
pn_src_prel="circle(29113.682,24601.185,400)"
m1_src_prel="circle(29113.682,24601.185,400)"
m2_src_prel="circle(29113.682,24601.185,400)"
pn_bkg="circle(26507.731,24318.795,1817.3131)"
m1_bkg="annulus(29113.682,24601.185,720,1300)"
m2_bkg="annulus(29113.682,24601.185,720,1300)"
t_before=594009375
t_rise=594009575
t_mid=594009635
t_fade=594009750
...
# emllist_idx=1
# DET_ML=161.4162, (263.236625279423, 43.5124998191442)
# uncertainty (1.079853**2+1.2**2)**0.5/3600.=0.00044842681986972217=1.6143365515309998 arcsec
coo="17:32:56.7901 +43:30:44.999"
coo_fit="circle(29114.873,24618.161,400)"
# optradius: 40 arcsecs 800 image units (limited to 37.5, 750)
# optradius: 25 arcsecs 500 image units
# optradius: 36 arcsecs 720 image units
pn_src="circle(29114.873,24618.161,750)"
m1_src="circle(29114.873,24618.161,500)"
m2_src="circle(29114.873,24618.161,720)"
tpeak_min=594009619.161392
tpeak_max=594009630.68294
tpeak_bin=11.521550
...
mk_spec () {
    ...
    evselect table=${id}_m2_clean_evt_${1}.fits withspectrumset=yes \
             ...
             expression="(X,Y) IN ${m2_bkg}"
    if [ ${1} = "first" ]; then
        tmp=$(fkeyprint ${id}_m2_spec_src_${1}.fits EXPOSURE | grep EXPOSURE | tail -1 | awk '{print $2}')
        fthedit "${id}_m2_spec_bkg_${1}.fits" EXPOSURE add ${tmp}
    fi
