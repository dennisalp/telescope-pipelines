...
pn_src="circle(26224.867,27962.792,400)"
m1_src="circle(26224.867,27962.792,500)"
m2_src="circle(26224.867,27962.792,500)"
pn_bkg="annulus(26224.867,27962.792,600,1800)"
m1_bkg="annulus(26224.867,27962.792,600,1800)"
m2_bkg="annulus(26224.867,27962.792,600,1800)"
...
# merge set1=0244_0083250101_EMOS1_S002_ImagingEvts.ds \
#       set2=0244_0083250101_EMOS1_U002_ImagingEvts.ds \
#       outset=tmp.fits
# merge set1=tmp.fits \
#       set2=0244_0083250101_EMOS1_U003_ImagingEvts.ds \
#       outset=tmp2.fits
# merge set1=tmp2.fits \
#       set2=0244_0083250101_EMOS1_U004_ImagingEvts.ds \
#       outset=m1_merged.fits
# evselect table=m1_merged.fits withrateset=Y rateset=${id}_m1_bkg_flare.fits \
#          maketimecolumn=Y timebinsize=100 makeratecolumn=Y \
#          expression="#XMMEA_EM && (PI>10000) && (PATTERN==0)"
# dsplot table=${id}_m1_bkg_flare.fits x=TIME y=RATE

# merge set1=0244_0083250101_EMOS2_S003_ImagingEvts.ds \
#       set2=0244_0083250101_EMOS2_U002_ImagingEvts.ds \
#       outset=tmp.fits
# merge set1=tmp.fits \
#       set2=0244_0083250101_EMOS2_U003_ImagingEvts.ds \
#       outset=tmp2.fits
# merge set1=tmp2.fits \
#       set2=0244_0083250101_EMOS2_U004_ImagingEvts.ds \
#       outset=m2_merged.fits
# evselect table=m2_merged.fits withrateset=Y rateset=${id}_m2_bkg_flare.fits \
#          maketimecolumn=Y timebinsize=100 makeratecolumn=Y \
#          expression="#XMMEA_EM && (PI>10000) && (PATTERN==0)"
